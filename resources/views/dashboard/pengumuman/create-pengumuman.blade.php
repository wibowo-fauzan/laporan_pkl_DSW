...
<body>
    <div class="container position-absolute top-50 start-50 translate-middle">
        <div class="path-link-beranda mt-5">
            <a href="/admin/dashboard/dataagenda" class="text-decoration-none">Dashbord Data Pengumuman ></a>
            <a class="text-decoration-none text-dark">Create - Data Pengumuman</a>
        </div>
        <div class="d-flex">
