        ...
        <div class="main">
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow-lg p-3 mb-5 bg-body rounded-3" style="border: none;">
                    <div class="card-body">
                        <a href="/dashboard/beritadanartikel/create" class="btn btn-outline-dark mb-4">Create Berita & Artikel +</a>
                        <table class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th class="text-center" scope="col">ID</th>
                                    <th class="text-center" scope="col">Judul Berita & Artikel</th>
                                    <th class="text-center" scope="col">Deskripsi Berita & Artikel</th>
                                    <th class="text-center" scope="col">Gambar Berita & Artikel</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="text-center">{{ $BeritaAtikel->id }}</td>
                                    <td class="text-center">{{ Str::limit($BeritaAtikel->title, 30) }}</td>
                                    <td class="text-center">{{ Str::limit($BeritaAtikel->description, 30) }}</td>
                                    <td class="text-center">
                                        <img src="{{ asset('storage/' . $BeritaAtikel->image) }}" alt="Logo"
                                            style="width: 50px; height: 50px;" class="rounded-circle">
                                    </td>

                                    <td class="text-center">
                                        <div class="btn-group gap-2" role="group">
                                            <a href="{{ route('beritadanartikel.edit', ['beritaAtikel' => $BeritaAtikel->id]) }}" class="btn btn-outline-primary">Edit</a>
                                            <form method="POST" action="{{ route('beritadanartikel.destroy', ['beritaAtikel' => $BeritaAtikel->id]) }}">
                                                @csrf
                                                @method('DELETE')
