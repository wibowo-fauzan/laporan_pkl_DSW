...
<body>
    ...
    <div class="container mb-5">
        <div class="mt-5">
            ...
            <ul class="mt-4">
                <li>
                    <p>Perpustakaan Umum Kota Depok adalah salah satu lembaga yang berfungsi menyediakan layanan bacaan
                        dan informasi kepada masyarakat. Fungsi perpustakaan umum melibatkan peminjaman dan pengembalian
                        buku, sumber daya audiovisual, serta berbagai aktivitas pendukung literasi. Beberapa fitur dan
                        layanan yang mungkin ditemukan di perpustakaan umum ini meliputi:</p>
                </li>
                <div class="row mt-5 mb-5">
                    <div class="col-xl-4">
                        <div class="shadow p-3 mb-5 bg-body rounded p-2" style="height: 250px;">
                            ...
                            <ul>
                                <li>
                                    <p>Lokasi: Jl. Margonda Raya No.54, Depok </p>
                                <li>
                                    <p>Penjelasan: Merupakan perpustakaan utama di kota ini, menyediakan beragam koleksi
                                        buku dan fasilitas untuk masyarakat umum.</p>
                                </li>
                    ...
                    <div class="col-xl-4">
                        <div class="shadow p-3 mb-5 bg-body rounded p-2" style="height: 250px;">
                            ...
                            <ul>
                                ...
                                <li>
                                    <p>Fokus pada koleksi literatur dan referensi yang mendukung mahasiswa dan akademisi
                    ...
                    <div class="col-xl-4">
                        <div class="shadow p-3 mb-5 bg-body rounded p-2" style="height: 250px;">
                            ...
                            <ul>
                                ...
                                <li>
                                    <p>Setiap perguruan tinggi swasta di Depok biasanya memiliki perpustakaan sendiri
                                        dengan koleksi yang mendukung kurikulum dan penelitian.</p>
                                </li>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="col-xl-4">
                        <div class="shadow p-3 mb-5 bg-body rounded p-2" style="height: 250px;">
                            ...
                            <ul>
                                ...
                                <li>
                                    <p>Setiap kecamatan di Kabupaten Depok umumnya memiliki perpustakaan daerah yang
                                        menyediakan layanan bagi penduduk setempat</p>
                                </li>
                                </li>
                            </ul>
                        </div>
